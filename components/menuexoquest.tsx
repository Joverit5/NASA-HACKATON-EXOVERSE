...
export default function ExoPlanetPlatform() {
  ...
  const handleExoQuestRedirect = useCallback(
    (difficulty: string) => {
                ...
                >
                  <CardHeader className="px-0 pt-0">
                    ...
                    <CardDescription className="text-lg text-indigo-200">
                      Challenge your exoplanet knowledge
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="px-0">
                    <p className="mb-6 text-lg text-indigo-100">
                      Ready to embark on a cosmic journey? ExoQuest challenges
                      you with fascinating questions about distant worlds and
